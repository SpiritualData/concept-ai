        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">
              We're pioneering a new frontier in knowledge automation, combining
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2">Evidence Evaluation</h4>
              <p className="text-lg text-gray-400 text-center">
                Presenting the most reliable evidence for and against each
                hypothesis.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Streamlining Innovation</h4>
              <p className="text-lg text-gray-400 text-center">
                Accelerating R&D through predictive analytics and intelligent
                concept evaluation.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Auto Critical Thinking</h4>
              <p className="text-lg text-gray-400 text-center">
                Enhancing decision-making with automated hypothesis generation
