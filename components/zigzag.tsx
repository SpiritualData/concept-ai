      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">Revolutionize Your Research</div>
            <h1 className="h2 mb-4">Empowering Truth with AI</h1>
            <p className="text-xl text-gray-400">Uncover objective truths across disciplines with Concept AI's revolutionary truth calculation API.</p>
          </div>
